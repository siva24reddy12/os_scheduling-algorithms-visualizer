...
def FCFS_scheduling_algorithm(job_queue):
    ...
    algorithm_procedure_output_file = create_file("./output/FCFS/", "FCFS - Scheduling Timeline Flow", ".txt")
    algorithm_analysis_output_file = create_file("./output/FCFS/", "FCFS_Algorithms_Analysis", ".txt")
    processes_analysis_output_file = create_file("./output/FCFS/", "FCFS - Job-Queue's Processes' Analysis", ".txt")
...
def RR_scheduling_algorithm(job_queue):
    ...
    algorithm_procedure_output_file = create_file("./output/RR/", "RR - Scheduling Timeline Flow", ".txt")
    algorithm_analysis_output_file = create_file("./output/RR/", "RR_Algorithms_Analysis", ".txt")
    processes_analysis_output_file = create_file("./output/RR/", "RR - Job-Queue's Processes' Analysis", ".txt")
...
def SPN_scheduling_algorithm(job_queue):
    ...
    algorithm_procedure_output_file = create_file("./output/SPN/", "SPN - Scheduling Timeline Flow", ".txt")
    algorithm_analysis_output_file = create_file("./output/SPN/", "SPN_Algorithms_Analysis", ".txt")
    processes_analysis_output_file = create_file("./output/SPN/", "SPN - Job-Queue's Processes' Analysis", ".txt")
...
def SRTF_scheduling_algorithm(job_queue):
    ...
    algorithm_procedure_output_file = create_file("./output/SRTF/", "SRTF - Scheduling Timeline Flow", ".txt")
    algorithm_analysis_output_file = create_file("./output/SRTF/", "SRTF_Algorithms_Analysis", ".txt")
    processes_analysis_output_file = create_file("./output/SRTF/", "SRTF - Job-Queue's Processes' Analysis", ".txt")
...
def MLFQ_scheduling_algorithm(job_queue):
    ...
    algorithm_procedure_output_file = create_file("./output/MLFQ/", "MLFQ - Scheduling Timeline Flow", ".txt")
    algorithm_analysis_output_file = create_file("./output/MLFQ/", "MLFQ_Algorithms_Analysis", ".txt")
    processes_analysis_output_file = create_file("./output/MLFQ/", "MLFQ - Job-Queue's Processes' Analysis", ".txt")
...
def HRRN_scheduling_algorithm(job_queue):
    ...
    algorithm_procedure_output_file = create_file("./output/HRRN/", "HRRN - Scheduling Timeline Flow", ".txt")
    algorithm_analysis_output_file = create_file("./output/HRRN/", "HRRN_Algorithms_Analysis", ".txt")
    processes_analysis_output_file = create_file("./output/HRRN/", "HRRN - Job-Queue's Processes' Analysis", ".txt")
